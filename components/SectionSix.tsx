...
const SectionSix: React.FC<SectionSixProps> = ({ data, updateData }) => {
  ...
  // Calculate percentage. Since score can be negative, we treat max as the 100% benchmark for positive traits.
  // If score is negative, percentage is 0 for gauge purposes, or we can show actual ratio.
  // The prompt asks for "Percentage of Total", usually meaning (Score / Max) * 100.
  ...
  // Gauge SVG Calculation (Semi-circle)
  // radius = 40, circumference ~ 126
  // stroke-dasharray = (percent/100 * 126) 126
